...
idCVar timescale(					"timescale",				"1",			CVAR_GAME | CVAR_FLOAT, "scales the time");
...
// RAVEN BEGIN
idCVar pm_sprintspeed(				"pm_sprintspeed",					"320",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT | CVAR_NORESET, "speed the player can move while sprinting");
